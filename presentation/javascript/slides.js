...
/*
   Modifications to allow offline usage
...
function addPrettify() {
  ...
  el.src = PERMANENT_URL_PREFIX + 'javascript/prettify.js';
  el.onload = function() {
    prettyPrint();
  }
...
function addFontStyle() {
  ...
  el.rel = 'stylesheet';
  el.type = 'text/css';
  el.href = PERMANENT_URL_PREFIX + 'stylesheets/fonts.css';
  document.body.appendChild(el);
};
...
if (!window['_DEBUG'] && document.location.href.indexOf('?debug') !== -1) {
  ...
  script.src = '../javascript/slides.js';
